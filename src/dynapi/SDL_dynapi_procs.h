...
SDL_DYNAPI_PROC(bool,SDL_RenderTextureRotatedEx,(SDL_Renderer *a, SDL_Texture *b, const SDL_FRect *c, const SDL_FRect *d, double e, const SDL_FPoint *f, SDL_FlipMode g, const SDL_FColor *h),(a,b,c,d,e,f,g,h),return)
